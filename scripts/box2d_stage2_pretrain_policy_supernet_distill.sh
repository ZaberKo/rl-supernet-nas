...
python stage2_pretrain_policy_supernet_distill.py \
  ...
  --teacher_checkpoint runs/box2d_carracing/stage1_max_subnet_ppo/max_subnet_ppo_best.pt \
  --output_dir runs/box2d_carracing/stage2_policy_supernet_distill_pretrain \
  --random_subnets 2 \
